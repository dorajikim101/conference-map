...
const eventData: EventData[] = [
  ...
  },
  {
    ...
    archive: {
      ...
      sponsors: 180,
      media: 130,
      eventTitle: "Consensus Toronto 2025",
      notes: ["102개국 14,771명 참가", "거래, DeFi, 기관 채택, AI+크립토가 핵심", "250개 사이드 이벤트, 역대 최대 규모"],
    },
    kpis: [
  ...
  },
  {
    ...
    feed: [
      { label: "서포터즈 30명 모집 중 (5/11 마감)", time: "2026-05-04", type: "모집" },
      { label: "전년 Preston Pysh·Dennis Porter 참석", time: "2025 참조", type: "연사" },
      { label: "한국 금투협 참석 사례", time: "2025 참조", type: "정책" },
    ],
    archive: {
      year: "2025",
      attendees: "2,000+",
  ...
  },
  {
    ...
    summary: {
      features: ["베트남 프리미어 블록체인·디지털 자산 서밋", "Resolution 05/2025 및 베트남 디지털 자산법 2026 집중", "기관 대상 규제 프레임워크 논의"],
      difference: ["베트남 규제·정책 특화", "동남아 시장 진출 교두보", "기관 배포 중심"],
    ...
    feed: [
      { label: "티켓 판매 오픈", time: "2개월 전", type: "비용" },
      { label: "연사 라인업 발표", time: "1개월 전", type: "연사" },
      { label: "베뉴 확정", time: "3개월 전", type: "운영" },
    ],
    archive: {
      year: "",
      attendees: "",
    ...
    sideEventTrend: [],
    actions: ["티켓 사전 구매 검토", "베트남 비자 확인", "동남아 파트너 리스트 준비"],
    companies: [],
    sideEvents: {
      count: 0,
      label: "사이드 이벤트 미공개",

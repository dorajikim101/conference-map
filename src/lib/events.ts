...
const eventData: EventData[] = [
  ...
  },
  {
    ...
    sideEventUrl: "https://luma.com/bitcoin-asia-2026",
  ...
  },
  {
    ...
    sideEventUrl: "https://koreablockchainweek.com/",
  ...
  },
  {
    ...
    cost: { flight: 0, hotel: 0, transport: 50, meals: 80, ticket: 100, total: 230, note: "국내 행사. 항공/숙박 불필요. 날짜 추정" },
    summary: {
    ...
    actions: ["2026 날짜 발표 모니터링", "10% 할인코드(OnlyBS) 확인", "비트코인 커뮤니티 네트워킹 준비"],
    companies: [
